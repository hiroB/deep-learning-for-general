...
##### STRIPS
「前提条件」「行動」「結果」の3つの組み合わせでプランニングを記述する。

##### SHRDLU
テリー・ウィノグラードが1968-1970年に開発した
コンピュータの中に「積み木の世界」と呼ばれる仮想世界を構築し人間が自然言語により指示することでシミュレートが可能なシステム
「積み木の世界」に限ることでプランニングを完全に実現する研究
...
##### αβ法
Mini-Max法で、探索の木を減らすために、スコア選択の過程でノードを外す方法。
最大スコア選択過程でスコアの小さいノードを外すβカット、最小スコア選択過程でスコアの大きいノードを外すαカットからなる。
...
##### センチメント分析
意味解析の一つ。文章の意見がポジティブなものかネガティブなものかニューラルなものかを分類する。

##### 含意関係認識
意味解析の一つ。二つの文章に含意関係（一方が正しいとき、もう一方も正しい）が成り立つのかどうかを分析する。
